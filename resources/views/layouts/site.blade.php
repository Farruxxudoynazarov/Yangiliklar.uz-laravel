...
<head>
  ...
  <title> @yield('title') - Buxoroliklar 24</title>
          ...
          <div class="header__actions basic-flex">
            ...
            <div class="languages">
              ...
              <ul class="languages__list">
                <a href="/lang/uz" class="btn language__option language__option--uz" data-status="disabled">O'z</a>
              </ul>

              @else

              <a href="#" class="btn language__option language__option--uz" data-status="disabled">UZ</a>
